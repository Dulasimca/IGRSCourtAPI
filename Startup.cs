...
namespace IGRSCourtAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<EF_IGRSCC_DataContext>(db => db.UseNpgsql(Configuration.GetConnectionString("IGRSCCDB")));

            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "IGRSCourtAPI", Version = "v1" });
            });
        }

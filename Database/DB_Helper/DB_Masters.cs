    ...
    public class DB_Masters
    {
        ...
        public Masters_Model GetMasters()
        {
           ...
           // List<Menu_Model> menu_Models = new List<Menu_Model>();
            ...
            List<Mainprayer_master_Model> mainprayer_Master_Models = new List<Mainprayer_master_Model>();
            ...
            try
            {
               ...
               // var MenuMasterList = _DataContext.Menumasters.ToList();
                ...
                var MainprayerList = _DataContext.mainprayermaster.ToList();
                ...
                MainprayerList.ForEach(row => mainprayer_Master_Models.Add(new Mainprayer_master_Model()
                {
                ...
                Masters_Model masters_Model = new Masters_Model
                {
                    ...
                    mainprayer_Masters = mainprayer_Master_Models
